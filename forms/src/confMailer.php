...
try {
	...
	$mail->isHTML(true);
	$mail->Subject = 'Teste de email via gmail Canal PERLA TI';
	$mail->Body = 'Chegou o email teste do <strong>Perla TII</strong>';
	$mail->AltBody = 'Chegou o email teste Perla TIII';
